...
import com.feilena.own.block.BoronBlock;
import com.feilena.own.block.BoronOre;
import com.feilena.own.block.CobaltBlock;
import com.feilena.own.block.CobaltOre;
import com.feilena.own.block.CopperBlock;
import com.feilena.own.block.CopperOre;
import com.feilena.own.block.MagnesiumBlock;
import com.feilena.own.block.MagnesiumOre;
import com.feilena.own.block.ManganeseBlock;
import com.feilena.own.block.ManganeseOre;
import com.feilena.own.block.MolybdenumBlock;
import com.feilena.own.block.MolybdenumOre;
import com.feilena.own.block.PhosphorousBlock;
import com.feilena.own.block.PhosphorousOre;
import com.feilena.own.block.SeleniumBlock;
import com.feilena.own.block.SeleniumOre;
import com.feilena.own.block.SodiumOre;
import com.feilena.own.block.ZincBlock;
